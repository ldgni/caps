...
export default function HomePage() {
  ...
  return (
    <main>
      <div className="container mx-auto space-y-12 border-b-2 border-[#2e160e] p-4 md:border-x-2">
        {/* First Product - VHS Keyboard */}
        <section className="space-y-4 border-b-2 border-[#2e160e] pb-8">
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:gap-12">
            <div className="space-y-4 lg:w-1/2">
              ...
              <p className="text-gray-700">
                ...
                VHS tapes. The keyboard features a vintage aesthetic with a
                modern twist, making it perfect for both retro enthusiasts and
                modern gamers alike.
              </p>
              <p className="text-gray-700">
              ...
              <p className="text-gray-700">
                ...
                aesthetics to create a truly unique typing experience that
                stands out from conventional keyboards on the market.
              </p>
              <p className="text-gray-700">
          ...
          <div className="flex flex-col gap-8 lg:flex-row-reverse lg:gap-12">
            <div className="space-y-4 lg:w-1/2">
              ...
              <p className="text-gray-700">
                ...
                to the golden age of gaming. This keyboard combines the tactile
                satisfaction of modern mechanical switches with a design
                inspired by classic 8-bit gaming systems from the 1980s.
              </p>
              <p className="text-gray-700">
                Each key press delivers that satisfying click reminiscent of the
                controllers and computers that defined an era of gaming history.
                The pixel-art inspired keycaps and vibrant color scheme
                instantly transport you back to the days of sprite-based
                graphics and chiptune soundtracks.
              </p>
              <p className="text-gray-700">
                We&apos;ve carefully balanced retro aesthetics with modern
                functionality, creating a keyboard that&apos;s not just a visual
                statement but a high-performance typing and gaming tool. The
                custom LED lighting can be programmed to display pixel-art
                patterns or react to your keystrokes.
              </p>
              <p className="text-gray-700">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t-2 border-dotted border-[#2e160e] pt-4">
                    <ul className="list-inside list-disc space-y-2 text-gray-700">
                      ...
                      <li>RGB backlighting with programmable 8-bit patterns</li>
